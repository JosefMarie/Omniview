...
const OmniViewLogo = () => (
    <span className="material-symbols-outlined" style={{ color: 'white', fontSize: '2.5rem' }}>confirmation_number</span>
);
        ...
        <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
            <div className="glass-card" style={{ 
                ...
                <button onClick={onClose} style={{
                    ...
                    background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', cursor: 'pointer', fontSize: '1.5rem',
                ...
                {!forgotMode && (
                    <>
                        ...
                        <p style={{ textAlign: 'center', marginTop: '2rem', color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem', fontWeight: 500 }}>
                            {mode === 'login' ? "NEW TO OMNIVIEW? " : 'ALREADY A MEMBER? '}
